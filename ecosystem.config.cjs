...
module.exports = {
  apps: [
    ...
    {
      name: 'xpdcnet-worker-telemetry-snapshot',
      cwd: ROOT,
      script: 'src/workers/mikrotikTelemetrySnapshotWorker.js',
      interpreter: 'node',
      exec_mode: 'fork',
      instances: 1,
      env_file: '.env',
      env: {
        NODE_ENV: 'production',
        MIKROTIK_TELEMETRY_SNAPSHOT_POLL_MS: '60000',
        MIKROTIK_TELEMETRY_SNAPSHOT_TIMEOUT_MS: '20000',
      },
      autorestart: true,
      watch: false,
      time: true,
    ...
    },
    {
      ...
      env: {
        NODE_ENV: 'production',
        STALE_WORKER_INTERVAL_MS: '60000',
        AGENT_STALE_MS: '120000',
        AGENT_OFFLINE_MS: '300000',
      },
      autorestart: true,
      watch: false,
      time: true,
