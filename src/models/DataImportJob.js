...
const DataImportJobSchema = new mongoose.Schema(
  {
    ...
    totalAccessRows: { type: Number, default: 0 },
    multiAccessCustomers: { type: Number, default: 0 },
    criticalDuplicateRows: { type: Number, default: 0 },
    validRows: { type: Number, default: 0 },
    duplicateRows: { type: Number, default: 0 },
    invalidRows: { type: Number, default: 0 },
    matchedPppoeRows: { type: Number, default: 0 },
    unmatchedPppoeRows: { type: Number, default: 0 },
    importedRows: { type: Number, default: 0 },
    importedAccessRows: { type: Number, default: 0 },
